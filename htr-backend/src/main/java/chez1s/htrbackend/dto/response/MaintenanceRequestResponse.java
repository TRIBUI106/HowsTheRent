...
public record MaintenanceRequestResponse(
    ...
    public static MaintenanceRequestResponse from(MaintenanceRequest m) {
        return new MaintenanceRequestResponse(
                ...
                m.getTitle(),
                m.getDescription(),
                m.getImages() != null ? List.copyOf(m.getImages()) : List.of(),
                m.getStatus().name(),
                ...
                m.getTicketCode(),
                m.getPreferredTimeSlots() != null ? List.copyOf(m.getPreferredTimeSlots()) : List.of(),
                m.getConfirmedTimeSlot(),
                m.getConfirmSlotByTenant() != null ? m.getConfirmSlotByTenant() : false,
                m.getSlotDeclinedByTenant() != null ? m.getSlotDeclinedByTenant() : false,
                m.getCompletionImages() != null ? List.copyOf(m.getCompletionImages()) : List.of(),
                m.getAttachmentVideo(),
                m.getCompletionVideo(),
                m.getStartedAt(),
